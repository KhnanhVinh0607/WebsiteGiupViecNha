        ...
        <ModalBody>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Select
              ...
              value={editService.address ? editService.address.split(", ") : []} // Tách chuỗi thành mảng khi hiển thị
              onChange={(selectedValues) => {
                // Chuyển mảng thành chuỗi các giá trị không lặp lại và cập nhật vào editService.address
                const uniqueAddresses = Array.from(new Set(selectedValues)); // Đảm bảo không có giá trị trùng lặp
