      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Select
              mode="multiple" // Cho phép chọn nhiều địa chỉ
              placeholder="Chọn địa chỉ"
              value={newService.address ? newService.address.split(", ") : []} // Chuyển chuỗi thành mảng khi hiển thị
              onChange={(selectedValues) => {
                // Loại bỏ các giá trị trùng lặp bằng cách chỉ lấy giá trị duy nhất từ selectedValues
                const uniqueAddresses = Array.from(new Set(selectedValues));
                const addresses = uniqueAddresses.join(", "); // Chuyển mảng thành chuỗi các giá trị cách nhau bởi dấu phẩy
